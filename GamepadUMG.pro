...
unrealRootPath=/home/psychojau/Unreal4/UnrealEngine
GamepadUMGRootPath=/media/donnees/Dev-jeux-applis/Unreal4/Plugins/UE4GamepadUMG/UE4GamepadUMG

gameProjectFile=/media/donnees/Dev-jeux-applis/Unreal4/Plugins/UE4GamepadUMG/UE4GamepadUMG/GamepadUMG.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(GamepadUMGSource.pri)
include(GamepadUMGHeader.pri)
include(GamepadUMGConfig.pri)
include(GamepadUMGIncludes.pri)
include(GamepadUMGDefines.pri)
...
GamepadUMG-Linux-Debug.commands = $$build GamepadUMG Linux Debug  -project="\"$$gameProjectFile\"" $$args
GamepadUMG-Linux-DebugGame.commands = $$build GamepadUMG Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
GamepadUMG-Linux-Shipping.commands = $$build GamepadUMG Linux Shipping  -project="\"$$gameProjectFile\"" $$args
GamepadUMG-Linux-Test.commands = $$build GamepadUMG Linux Test  -project="\"$$gameProjectFile\"" $$args
GamepadUMG.commands = $$build GamepadUMG Linux Development  -project="\"$$gameProjectFile\"" $$args

GamepadUMGEditor-Linux-Debug.commands = $$build GamepadUMGEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
GamepadUMGEditor-Linux-DebugGame.commands = $$build GamepadUMGEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
GamepadUMGEditor-Linux-Shipping.commands = $$build GamepadUMGEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
GamepadUMGEditor-Linux-Test.commands = $$build GamepadUMGEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
GamepadUMGEditor.commands = $$build GamepadUMGEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	GamepadUMG-Linux-Debug \
	GamepadUMG-Linux-DebugGame \
	GamepadUMG-Linux-Shipping \
	GamepadUMG-Linux-Test \
	GamepadUMG \
	GamepadUMGEditor-Linux-Debug \
	GamepadUMGEditor-Linux-DebugGame \
	GamepadUMGEditor-Linux-Shipping \
	GamepadUMGEditor-Linux-Test \
	GamepadUMGEditor \
