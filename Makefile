...
GamepadUMG-Linux-Debug:
	 $(PROJECTBUILD) GamepadUMG Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

GamepadUMG-Linux-DebugGame:
	 $(PROJECTBUILD) GamepadUMG Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

GamepadUMG-Linux-Shipping:
	 $(PROJECTBUILD) GamepadUMG Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

GamepadUMG-Linux-Test:
	 $(PROJECTBUILD) GamepadUMG Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

GamepadUMG:
	 $(PROJECTBUILD) GamepadUMG Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

GamepadUMGEditor-Linux-Debug:
	 $(PROJECTBUILD) GamepadUMGEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

GamepadUMGEditor-Linux-DebugGame:
	 $(PROJECTBUILD) GamepadUMGEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

GamepadUMGEditor-Linux-Shipping:
	 $(PROJECTBUILD) GamepadUMGEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

GamepadUMGEditor-Linux-Test:
	 $(PROJECTBUILD) GamepadUMGEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

GamepadUMGEditor:
	 $(PROJECTBUILD) GamepadUMGEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
